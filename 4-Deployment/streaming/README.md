...
# New version of logging in to ECR
REGION=us-east-1
REGISTRY_ID=886638369043
aws ecr get-login-password --region ${REGION} | docker login -u AWS --password-stdin ${REGISTRY_ID}.dkr.ecr.${REGION}.amazonaws.com
```
...
REGION=us-east-1
REGISTRY_ID=886638369043
REMOTE_URI="${REGISTRY_ID}.dkr.ecr.${REGION}.amazonaws.com/duration-model"
REMOTE_TAG="v1"
